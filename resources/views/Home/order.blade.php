                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" placeholder="system abbreviation">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">问题类型</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" placeholder="problem type">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">问题描述</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea type="text"  class="form-control" rows="3" placeholder=" problem description"></textarea>
                        </div>
                      </div>
